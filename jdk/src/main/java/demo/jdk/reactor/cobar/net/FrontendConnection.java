...
import demo.jdk.reactor.cobar.config.Capabilities;
import demo.jdk.reactor.cobar.config.ErrorCode;
import demo.jdk.reactor.cobar.handlers.FrontendAuthenticator;
import demo.jdk.reactor.cobar.handlers.FrontendPrepareHandler;
import demo.jdk.reactor.cobar.handlers.FrontendPrivileges;
import demo.jdk.reactor.cobar.handlers.FrontendQueryHandler;
import demo.jdk.reactor.cobar.mysql.ErrorPacket;
import demo.jdk.reactor.cobar.mysql.HandshakePacket;
import demo.jdk.reactor.cobar.mysql.MySQLMessage;
import demo.jdk.reactor.cobar.mysql.OkPacket;
import demo.jdk.reactor.cobar.util.CharsetUtil;
import demo.jdk.reactor.cobar.util.RandomUtil;
import demo.jdk.reactor.cobar.util.TimeUtil;
import demo.jdk.reactor.cobar.util.Versions;
...
/**
 * @author sunqinwen
 * @version \: FrontendConnection.java,v 0.1 2019-04-04 11:22
 */
